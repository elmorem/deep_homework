...
def get_retriever(retriever: str):
    ...
    match retriever:
        ...
        case "searx":
            ...
            return SearxSearch
        case "searchapi":
            from homework_researcher.retrievers.searchapi.searchapi import (
                SearchApiSearch,
            )
        ...
        case "semantic_scholar":
            from homework_researcher.retrievers.semantic_scholar.semantic_scholar import (
                SemanticScholarSearch,
            )

            return SemanticScholarSearch
        case "pubmed_central":
            from homework_researcher.retrievers.pubmed_central.pubmed_central import (
                PubMedCentralSearch,
            )
